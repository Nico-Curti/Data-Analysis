...
int main(int argc, char *argv[])
{
	...
	std::cout << "index of min of array" << std::endl;
	...
	std::cout << "argsort array" << std::endl;
	...
	std::cout << "variance of array" << std::endl;
	...
	std::cout << "median of array" << std::endl;
	...
	std::cout << "autocorrelation of array" << std::endl;
